...
export default function RegisterPage() {
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center bg-gray-50 p-4 transition-colors duration-300"
    ...
    >
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-2xl">
        <div className="bg-[#0A6E7B] p-6 text-center flex flex-col items-center">
          ...
          <h1 className="text-2xl font-bold text-white tracking-wide">Daftar Akun</h1>
          <p className="text-white/80 text-xs mt-1 uppercase tracking-widest font-semibold">Bergabung dengan PT Aqlam</p>
        </div>
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-1" htmlFor="nama">
                Nama Lengkap
              </label>
              <input
                id="nama"
          ...
          <div className="mt-6 text-center text-sm">
            <Link href="/login" className="text-gray-500 hover:text-[#0A6E7B] transition-colors">
              Sudah punya akun? <span className="font-semibold text-[#0A6E7B] hover:underline">Masuk di sini</span>
            </Link>
          </div>
        </div>
      </div>
